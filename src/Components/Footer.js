        ...
        <div>
            <footer class="footer footer-center p-10 bg-base-200 text-base-content rounded">
                <div class="grid grid-flow-col gap-4">
                    ...
                    <Link to="/task" class="link link-hover">Task</Link>
                    <Link to="/member" class="link link-hover">Members</Link>
                </div>
                <div>
                    <div class="grid grid-flow-col gap-4">
                ...
                <div>
                    <p>Copyright © 2022 - All right reserved by Brain Station-23 Ltd</p>
                </div>
            </footer>
        </div>
    );
